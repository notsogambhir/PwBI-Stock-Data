...
description: >-
  Expert in AI provider management, multi-provider setups, and model
  configuration. Use PROACTIVELY when setting up providers, configuring models,
  or switching between AI services.
tools:
  - Read
  - Write
  - Edit
