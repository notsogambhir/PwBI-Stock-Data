...
description: >-
  Expert in real-time AI streaming implementations, chat interfaces, and
  streaming responses. Use PROACTIVELY when building chat applications,
  real-time interfaces, or streaming AI responses.
tools:
  - Read
  - Write
  - Edit
